...
/*
    self.connect = function(errorCallback) {
        ...
        console.log('Connecting to the UHK...');
        ...
        function tryToConnect() {
            ...
            if (foundDevices.length > 0) {
                ...
                console.log('Successfully connected to the UHK in %s mode.',
            ...
            if (retryTimeout <= 0) {
                return errorCallback('Could not connect to the UHK. Is it connected to the host?');
            }
