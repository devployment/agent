...
/*
    self.connect = function(errorCallback) {
        ...
        console.log('Connecting to the Ultimate Hacking Keyboard...');
        ...
        function tryToConnect() {
            ...
            if (foundDevices.length > 0) {
                ...
                console.log('Successfully connected to the Ultimate Hacking Keyboard in %s mode.',
...
*/
    self.connect = function(errorCallback) {
        ...
        function() {
            errorCallback('Could not connect to the Ultimate Hacking Keyboard. Is it connected to the host?');
        });
    };
    ...
    self.waitUntilDisconnect = function(errorCallback, successCallback) {
        ...
        function() {
            errorCallback('Could not disconnect the Ultimate Hacking Keyboard');
        });
    };
